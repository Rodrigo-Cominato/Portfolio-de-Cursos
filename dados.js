...
const DADOS = [
  ...
  },
  {
    ...
    cursos: [
      ...
      {
        nome_pt: "DD-P-VLT56 Vídeo de Configuração do FC202 Aqua Drive",
        nome_en: "DD-P-VLT56 FC202 Aqua Drive Setup Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VLT57 Vídeo de Configuração do FC302 Automation Drive",
        nome_en: "DD-P-VLT57 FC302 Automation Drive Setup Videon",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VLT59 Vídeo de Introdução ao Monitoramento Baseado em Condição",
        nome_en: "DD-P-VLT59 Introduction to Condition Based Monitoring Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VLT58 Vídeo de Introdução às Funcionalidades do MCT10",
        nome_en: "DD-P-VLT58 Introduction to MCT10 functionality Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VLT63 Vídeo de Gerenciamento de Parâmetros do MCT10",
        nome_en: "DD-P-VLT63 MCT10 Parameter Handling Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VLT60 Vídeo do Assistente de Manutenção Preventiva do MCT10",
        nome_en: "DD-P-VLT60 MCT10 Preventive Maintenance Wizard Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VLT61 Vídeo do Assistente de Eventos Programados do MCT10",
        nome_en: "DD-P-VLT61 MCT10 Timed Events Wizard Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VAC54 VACON 100 Fluxo industrial e vídeo de configuração 100X",
        nome_en: "DD-P-VAC54 VACON 100 Industrial Flow and 100X Setup Video",
        ano: "2025",
      ...
      {
        nome_pt: "DD-P-VAC60 Vídeo de Funcionalidades Básicas do Inversor VACON NC",
        nome_en: "DD-P-VAC60 VACON NC Drive Basic Functionality Video",
        ano: "2025",
