...
const DADOS = [
  ...
  },
  {
    ...
    cursos: [
      { nome: "AS-i e IO-Link", ano: "2024", 
       assuntos: [
         "Fundamentos do AS-i e IO-Link",
      ...
      { nome: "Comando e Proteção de Motores SMART", ano: "2024", 
       assuntos: [
         "Princípios de acionamento de motores",
         "Dispositivos inteligentes de proteção",
         "Parametrização e monitoramento",
         "Diagnóstico de falhas",
         "Comunicação industrial e integração ao CLP",
       ], certificado: "certificados/(2024) Siemens - Comando e Proteção de Motores SMART.pdf" },
      { nome: "Relé de Interface", ano: "2024", 
       assuntos: [
         "Funcionamento dos relés de interface",
         "Isolação entre circuitos",
         "Dimensionamento e seleção",
       ], certificado: "certificados/(2024) Siemens - Relé de Interface.pdf" },
      { nome: "Relés e Contatores de Estado Sólido", ano: "2024", 
       assuntos: [
         "Funcionamento dos SSRs",
         "Comparação entre contatores eletromecânicos e estado sólido",
         "Dissipação térmica",
         "Aplicações industriais",
       ], certificado: "certificados(2024) Siemens - Relés e Contatores de Estado Sólido.pdf" },
      { nome: "Aplicações em Abastecimento de Hidrogênio", ano: "2025", 
       assuntos: [
         "Cadeia de produção e abastecimento de hidrogênio",
         "Segurança em instalações",
         "Automação do processo",
       ], certificado: "certificados/(2025) Siemens - Aplicações em Abastecimento de Hidrogênio.png" },
      { nome: "Chaves de Partida e Soft Starters", ano: "2025", 
       assuntos: [
         "Métodos de partida de motores",
         "Configuração de soft starters",
         "Proteções elétricas",
         "Dimensionamento",
       ], certificado: "certificados/(2025) Siemens - Chaves de Partida Suave_Soft Starters.pdf" },
      { nome: "Correção de Fator de Potência Básico", ano: "2025", 
       assuntos: [
         "Conceitos de potência ativa, reativa e aparente",
         "Fator de potência",
      ...
      { nome: "Segurança de Máquinas", ano: "2025", 
       assuntos: [
         "NR-12 e normas internacionais",
         "Categorias e níveis de desempenho (PL)",
         "Relés e controladores de segurança",
         "Cortinas de luz e chaves de segurança",
         "Validação do sistema de segurança",
       ], certificado: "certificados/(2025) Siemens - Segurança de Máquinas .png" },
      { nome: "SIMOCODE", ano: "2025", 
       assuntos: [
         "Conceitos do sistema SIMOCODE",
         "Parametrização e configuração",
         "roteção e monitoramento de motores",
         "Diagnóstico de falhas",
         "Comunicação via PROFINET/PROFIBUS",
         "Integração com TIA Portal",
